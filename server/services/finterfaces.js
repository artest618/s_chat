        ...
        util.sendRequest(path, '', function(stat, result){
            ...
            if(stat == 200){
               ...
               // var usertype = result.userEdit.userRole == 1 ? 1 : result.userEdit.userRole == 2 ? 2 : 3;
                ...
                // var userName = (result.userEdit.userName&&(result.userEdit.userName.substr(1)+"经理"))||"";
                var user = {
                    name: (result.userEdit.nickName||(phone.substr(0,3)+"****"+phone.substr(7,10))),
                    uid: result.userEdit.userId,
                    cname: (result.userEdit.nickName||(phone.substr(0,3)+"****"+phone.substr(7,10))),
                    usertype: usertype,
                    headicon: result.userEdit.userImg
                }
                callback(user);
